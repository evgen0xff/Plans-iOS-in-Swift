...
class SendFeedbackVC: UserBaseVC {
    ...
    override func setupUI() {
        ...
        viewFeedBackText.placeholder = "Feedback"
    ...
    // MARK: - Api method for sending the feedback
    func sendFeedback() {
...
extension SendFeedbackVC : MediaPickerDelegate {
